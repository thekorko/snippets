<html>
<head>
<title>Commodore 64 Petscii Art @ Lunix Home</title>
<meta http-equiv=Content-Type content=text/html; charset=iso-8859-1>
<meta name="description" content="Commodore 64 petscii art by Lunix" />
...
<?PHP
  ...
  */
  ...
  $directory_name = "work_c64_petscii";
  $file_format = ".txt";

  ?>

  <h2>Commodore 64 Petscii Art</h2>
  ...
  */
  ...
  <a href="?img=fullscreen">Fullscreen</a><br>
  <a href="?img=instagram-fillers">Instagram Fillers</a>
    </td><td valign=top>
  ...
  */
  ...
  if(isset($_GET['img'])) {
    ...
    if (in_array(ucwords(preg_replace('/[-]/', ' ', $clean_variable)), $groups) or in_array($clean_variable, $menus = array('fullscreen','instagram-fillers'))) {
